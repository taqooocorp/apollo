package com.taqooo.crawler.tools;
...
public class HttpClientUtils {
    ...
    public static void main(String[] args) {
        String url1 = "http://st.lvyou.sankuai.com/volga/api/v69/trip/cate/home?utm_campaign=AgroupBgroupD200Ghomepage_category9_195__a1__c20070H0&ci=1&utm_medium=iphone&cityId=30&js_patch_version=3&userid=2707516&uuid=SDFKS345VCBKSLFKXVKLASAZCCM45RECV34XVEW&version=7.1.0&utm_term=7.1.0&msid=811BD8C8-5FCB-42DE-BCED-C8751604FCE62016-07-26-10-46366&version_name=7.1.0&movieBundleVersion=100&client=iphone&rn_package_version=0&__reqTraceID=DB7D149F-0BB7-4DC3-859A-8B6705136864&utm_content=E1F24E490E949713EE5364E86936B5E6B45E2002A3C963A29FF19606F0714199&utm_source=Alpha";
        String res = HttpClientUtils.sendGet(url1, null, null);
        for (int i = 0; i < 10; i++) {
            String res2 = HttpClientUtils.sendGet(url1, null, null);
            if (!res.equals(res2)) {
